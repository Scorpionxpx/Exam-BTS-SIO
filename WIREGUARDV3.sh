...
if ! apt update && apt install -y wireguard iptables; then
...
SERVER_IP="192.168.1.10" # Adresse IP du serveur WireGuard
CLIENT_IP="10.0.0.2"     # Adresse IP attribuée au client WireGuard
PORT="51820"             # Port WireGuard
EXTERNAL_INTERFACE="ens192" # Interface externe (pare-feu)
LAN_NETWORK="192.168.2.0/24" # Réseau LAN à atteindre
